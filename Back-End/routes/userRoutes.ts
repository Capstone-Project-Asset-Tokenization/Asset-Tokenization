...
userRouter.patch('/update-profile', authenticateUser, userController.updateProfile)
userRouter.patch('/change-password', authenticateUser, userController.changePassword)
